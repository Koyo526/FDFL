...
def plot_client_token_history(current_time:str):
    ...
    # ファイルパスの確認
    file_path = f'ChangeDatasize/{current_time}/clinet_token_history.csv'
    ...
    # グラフの保存
    plt.savefig(f'ChangeDatasize/{current_time}/0_client_token_amount_history.png', bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    now = datetime.datetime.now()
    current_time = now.strftime("%Y-%m-%d-%H-%M")
    SAVE_DIR = f"ChangeDatasize/{current_time}"
    ...
    # CLIENT_DATA_SIZE = [0.002, 0.002, 0.002, 0.002, 0.002, 0.198, 0.198, 0.198, 0.198, 0.198]
    CLIENT_DATA_SIZE = [0.02, 0.02, 0.02, 0.02, 0.02, 0.06, 0.06, 0.06, 0.06, 0.06, 0.12, 0.12, 0.12, 0.12, 0.12]
    # データセットのロード
